...
const ReceiptActions = ({ donationId, eventId, donorEmail, receiptRef, donorName, eventName }) => {
  ...
  const handleDownloadReceipt = async () => {
    ...
    try {
      ...
      const filename = `Receipt_${donationId}_${eventName.replace(/\s+/g, '_')}.pdf`;
  ...
  return (
    <div className="print:hidden flex flex-wrap justify-between items-center gap-2 mb-6">
      ...
      <div className="flex flex-wrap gap-2">
        <Button variant="outline" onClick={handlePrintReceipt} className="print:hidden">
          <Printer className="mr-2 h-4 w-4" />
          Print
        </Button>

        {donorEmail && (
          <Button variant="outline" onClick={handleEmailReceipt} className="print:hidden">
