      ...
      <div className="privacy-policy py-10">
        <div className="container mx-auto">
          <div className="mx-auto px-4 py-8">
            <h1 className="text-3xl font-bold mb-4">Privacy Policy for Charity Fund</h1>
            <p className="mb-4">
            ...
            <p className="mb-4">
              At Charity Fund (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;), we are committed
              to protecting your privacy. This Privacy Policy outlines how we collect, use,
              disclose, and safeguard your information when you visit our website [insert website
              URL], make a donation, volunteer, or participate in any of our programs or services.
            </p>
            ...
            <ul className="list-disc list-inside mb-4">
              <li>
                <strong>Personal Information:</strong> When you register for an event, donate, or
                volunteer, we may collect personal information, such as your name, email address,
                phone number, mailing address, and payment information.
              </li>
              <li>
                <strong>Non-Personal Information:</strong> We may also collect non-personal
                information about you automatically when you visit our website, such as your IP
                address, browser type, operating system, pages visited, and the time and date of
                your visit.
              </li>
            </ul>
            ...
            <ul className="list-disc list-inside mb-4">
              ...
              <li>To communicate with you about your donations, events, and programs.</li>
              <li>To provide you with updates about our charity’s activities and initiatives.</li>
              <li>To manage volunteer applications and communications.</li>
            ...
            <p className="mb-4">
              ...
              access, use, or disclosure. However, please remember that no method of transmission
            ...
            <ul className="list-disc list-inside mb-4">
              ...
              <li>
                <strong>Withdraw Consent:</strong> If we are processing your personal information
            ...
            <p className="mb-4">
              ...
              experience. Cookies are small files placed on your device that help us analyze web
              traffic and improve our website. You can choose to accept or decline cookies through
              your browser settings.
            </p>

            <h2 className="text-2xl font-semibold mt-6 mb-2">8. Third-Party Websites</h2>
            <p className="mb-4">
              Our website may contain links to third-party websites that are not operated by us. We
              have no control over the content and practices of these websites and cannot be
              responsible for their privacy policies. We encourage you to review the privacy
