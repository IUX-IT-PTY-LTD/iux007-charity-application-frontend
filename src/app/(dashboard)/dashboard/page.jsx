...
const Dashboard = () => {
  return (
    <div className="dashboard">
      <h3 className="text-gray-800 text-3xl font-extrabold">Dashboard</h3>
        ...
        <div className="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
          <div className="col-span-12 xl:col-span-8">
            <div className="rounded-[20px] bg-gray-50 border px-5 pb-2.5 pt-6 shadow-xl  sm:px-7.5 xl:pb-1">
              <h4 className="mb-6 text-xl font-bold text-black ">Donation History</h4>
              ...
              <div className="flex flex-col">
                ...
                <div className="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
                  <div className="flex items-center gap-3 p-2.5 xl:p-5">
                    ...
                    <p className="font-medium text-black  sm:block">Google</p>
                  </div>
                ...
                <div className="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
                  <div className="flex items-center gap-3 p-2.5 xl:p-5">
                    ...
                    <p className="font-medium text-black  sm:block">Twitter</p>
                  </div>
                ...
                <div className="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
                  <div className="flex items-center gap-3 p-2.5 xl:p-5">
                    ...
                    <p className="font-medium text-black  sm:block">Github</p>
                  </div>
                ...
                <div className="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
                  <div className="flex items-center gap-3 p-2.5 xl:p-5">
                    ...
                    <p className="font-medium text-black  sm:block">Vimeo</p>
                  </div>
                ...
                <div className="grid grid-cols-3 sm:grid-cols-5">
                  <div className="flex items-center gap-3 p-2.5 xl:p-5">
                    ...
                    <p className="font-medium text-black  sm:block">Facebook</p>
                  </div>
