        ...
        <div className="max-w-6xl mx-auto px-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                <p className="mb-8 text-lg text-body-color dark:text-dark-6">
                  At our core, we believe in the power of collective giving to transform lives. Our
                  platform connects generous donors with meaningful causes, creating lasting
                  positive impact in communities worldwide. Join us in building a better future for
                  all.
                </p>
                <Link
                  href="/donations"
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-body-color max-w-2xl mx-auto">
              We focus on key areas where we can make the most significant difference in people's
              lives.
            </p>
          </div>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 mb-20">
            <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-secondary mb-4">Community Development</h3>
              <p className="text-body-color dark:text-dark-6">
                Building stronger communities through sustainable development projects, education
                initiatives, and local empowerment programs.
              </p>
            </div>
            ...
            <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-secondary mb-4">Emergency Relief</h3>
              <p className="text-body-color dark:text-dark-6">
                Providing rapid response and support to communities affected by natural disasters
            ...
            <div className="p-8 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-2xl font-bold text-secondary mb-4">Healthcare Access</h3>
              <p className="text-body-color dark:text-dark-6">
                Improving access to quality healthcare services and medical resources for
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center">
                ...
                />
                <div className="ml-4">
                  <h4 className="text-xl font-bold text-secondary">Sarah Johnson</h4>
                  <p className="text-primary font-medium">Executive Director</p>
                  <p className="text-sm text-body-color mt-2">15+ years in nonprofit leadership</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center">
                ...
                />
                <div className="ml-4">
                  <h4 className="text-xl font-bold text-secondary">Michael Chen</h4>
                  <p className="text-primary font-medium">Operations Director</p>
                  <p className="text-sm text-body-color mt-2">Expert in global operations</p>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300">
              <div className="flex items-center">
                ...
                />
                <div className="ml-4">
                  <h4 className="text-xl font-bold text-secondary">Emma Rodriguez</h4>
