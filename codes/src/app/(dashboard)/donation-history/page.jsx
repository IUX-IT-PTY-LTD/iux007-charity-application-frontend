  ...
  return (
    <div className="donation-history">
      <form className="space-y-4">
        <div className="mb-8">
          <h3 className="text-gray-800 text-3xl font-extrabold">Donation History</h3>
        </div>

        <div className="flex justify-between items-end gap-3">
          <div className="w-full">
            <label className="text-gray-800 text-sm mb-2 block">Search</label>
          ...
          <div className="w-full">
            <label className="text-gray-800 text-sm mb-2 block">Filter</label>
            <div className="relative flex items-center">
              <select
                name="filter"
                required
          ...
          <table className="w-full table-auto">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border px-4 py-2">
                  <span className="bg-secondary text-white px-3 py-1 text-sm rounded-md">
                    Donated
                  </span>
                </td>
