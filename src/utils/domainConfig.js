...
const DOMAIN_CONFIGS = {
  ...
  'bicnsw.org.au': {
    API_BASE_URL: process.env.NEXT_PRIVATE_API_BASE_URL_BICNSW_PROD,
    NEXT_PUBLIC_STRIPE_PUBLISHABLE_KEY: process.env.NEXT_PRIVATE_STRIPE_PUBLISHABLE_KEY_BICNSW_PROD,
    NEXT_PUBLIC_GOOGLE_CLIENT_ID: process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID,
    NEXT_PUBLIC_GOOGLE_CLIENT_SECRET: process.env.NEXT_PUBLIC_GOOGLE_CLIENT_SECRET
  },
