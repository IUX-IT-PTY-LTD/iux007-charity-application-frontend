            ...
            <div className="space-y-8">
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  Welcome to the Charity Fund website (the "Site"). By accessing or using the Site,
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  or are using the Site with parental or guardian consent. If you are under the age
                  of 18, you may not use our Site without such consent.
                </p>
              </section>
              ...
              <section>
                ...
                <div className="space-y-4">
                  <p className="text-gray-600 leading-relaxed">
                    Donations made through the Site are processed securely. You agree to provide
                    accurate and complete information when making a donation and to update such
                    information as necessary.
                  </p>
                  <p className="text-gray-600 leading-relaxed">
                    All donations are non-refundable unless otherwise stated. By making a donation,
                    you acknowledge that you have read and understood our donation policy.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-600 pl-4">
                  <li>
                    Using the Site for any unlawful purpose or in violation of any applicable law.
                  </li>
                  <li>
                  ...
                  <li>
                    Attempting to gain unauthorized access to the Site or its related systems or
                    networks.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  images, is the property of Charity Fund or its content suppliers and is protected
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  practices. We encourage you to review the terms and conditions and privacy
              ...
              <section>
                ...
                <p className="text-gray-600 leading-relaxed">
                  ...
                  effective when we post the revised terms on this page with a new effective date.
              ...
              <section>
                ...
                <div className="bg-gray-50 p-6 rounded-lg">
                  <p className="text-gray-700">
                    ...
                    Dhaka, Bangladesh <br />
                    <a
                      href="mailto:charity.fund@gmail.com"
                      className="text-blue-600 hover:underline"
                    >
                      charity.fund@gmail.com
                    </a>{' '}
                    <br />
                    <a href="tel:+8800000000000" className="text-blue-600 hover:underline">
                      +8800000000000
                    </a>
                  </p>
                </div>
