    ...
    <div className="donation-details py-10">
      <div className="container mx-auto">
        <div className="text-center">
          <h2 className="text-3xl font-bold langar">Event Name</h2>
        </div>
        ...
        <div className="grid lg:w-[90%] w-full mx-auto bg-white p-10 shadow-xl rounded-[10px] border mt-10 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10">
          ...
          <div className="image col-span-1">
            <Image
              ...
              src="/assets/img/event-img.jpg"
              alt="Event Name"
            />
          </div>
          <div className="content xl:col-span-3 lg:col-span-2 col-span-1">
            <h3 className="text-xl mb-4 font-bold langar">Event Name</h3>
            <p className="text-gray-500 mt-1 text-lg">
              Our Hot Meals for 100 Orphans program provides warm, nutritious meals to children in
              need this winter. Each meal brings essential nourishment and reminds them they are
              valued. With your support, we can bring comfort and hope to these 100 young hearts.
              Donate today to fill their plates—and hearts—with warmth this winter.
            </p>

            <form action="./checkout" className="flex gap-5 mt-10">
              <select
                name=""
                className="currency border px-4 py-2 rounded-md w-full appearance-none"
                id=""
              >
              ...
              <select
                name=""
                className="timeline border px-4 py-2 rounded-md w-full appearance-none"
                id=""
              >
              ...
              <input
                type="number"
                placeholder="Amount"
                className="amount border px-4 py-2 rounded-md w-full"
              />
              <button className="px-5 py-2 bg-primary text-white rounded-md">Donate</button>
            </form>
          </div>
        </div>
